...
const adUnitId = __DEV__
	? TestIds.BANNER
	: Platform.OS === 'ios'
	? 'ca-app-pub-4744918320429923/9787578883'
	: 'ca-app-pub-4744918320429923/9928051820';
	...
	const handleSubmit = async (values: SendQuestion) => {
		...
		return item.inScreen
			...
			: navigation.navigate(routes.MY_QUESTIONS.name, {
					screen: routes.MY_QUESTIONS_MAIN.name,
			  });
	};
					...
					<Button
						...
						onPress={() =>
							item.inScreen
								...
								: navigation.navigate(
										routes.MY_QUESTIONS.name,
										{
											screen: routes.MY_QUESTIONS_MAIN
												.name,
										}
								  )
						}
			...
			<ScrollView contentContainerStyle={styles.form}>
				<Form
					...
					<IconTextBox
						text={
							item.edit
								? 'Please use only English to complete the form (edit mode)'
								: user?.translate?.note
								? user?.translate?.note
					...
					<FormField
						...
						maxLength={200}
						multiline
						allowAnyText={item.edit ? false : true}
